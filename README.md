...
1. Install [Cursor IDE](https://www.cursor.com/), select default settings (or change them) and log in. If you had it installed before, Cmd+Shift+P "Attempt Update" to get the latest update
